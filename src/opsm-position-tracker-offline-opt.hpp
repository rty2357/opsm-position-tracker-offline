/*
 * observation-probability-position-tracker-offline-opt.hpp
 *
 *  Created on: 2011/12/22
 *      Author: tyamada
 */

#ifndef OBSERVATION_PROBABILITY_POSITION_TRACKER_OFFLINE_OPT_HPP_
#define OBSERVATION_PROBABILITY_POSITION_TRACKER_OFFLINE_OPT_HPP_
	...
	namespace PositionTracker {
		...
		inline bool options::get_option(int aArgc, char **aArgv)
		{
			...
			while(1){
				...
				case 'S': ::strcpy( param->ls_logname.value, optarg);		break;
				// entry sokuiki ssm-data id
				case 'O': ::strcpy( param->odm_logname.value, optarg);		break;
